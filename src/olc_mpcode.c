...
MPEDIT( mpedit_list )
{
     ...
     {
          if ( fAll )
               bprintf( buffer, "No existing MobPrograms.\n\r" );
          else
               bprintf( buffer, "No existing MobPrograms in this area.\n\r" );
     }
...
OPEDIT( opedit_list )
{
     ...
     {
          if ( fAll )
               bprintf( buffer, "No existing ObjPrograms.\n\r" );
          else
               bprintf( buffer, "No existing ObjPrograms in this area.\n\r" );
     }
...
RPEDIT( rpedit_list )
{
     ...
     {
          if ( fAll )
               bprintf( buffer, "No existing RoomPrograms.\n\r" );
          else
               bprintf( buffer, "No existing RoomPrograms in this area.\n\r" );
     }
